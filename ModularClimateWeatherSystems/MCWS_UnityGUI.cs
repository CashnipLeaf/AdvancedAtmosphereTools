    ...
    partial class MCWS_FlightHandler
    {
        ...
        void DrawWindow(int windowID)
        {
            ...
            if (activevessel != null && mainbody != null)
            {
                ...
                double dragforce = 0.0f;
                double liftdragratio = 0.0f;
                double liftinduceddrag = 0.0f;
                ...
                string h_windspeed = string.Format("{0:F1} {1}", Math.Sqrt(Math.Pow(Multipliedwindvec.x, 2) + Math.Pow(Multipliedwindvec.z, 2)), Speedunit);
                ...
                {
                    Vector3d nvel = (activevessel.srf_velocity - AppliedWind).normalized;
