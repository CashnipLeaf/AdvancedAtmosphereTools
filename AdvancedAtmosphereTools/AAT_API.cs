...
namespace AdvancedAtmosphereTools
{
    ...
    public static class AAT_API
    {
        ...
        private static AAT_FlightHandler Instance => AAT_FlightHandler.Instance;
        ...
        private static AAT_Startup InternalData => AAT_Startup.Instance;
